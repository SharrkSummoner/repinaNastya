...
public class SecondDishActivity extends ListActivity {

    private resAdapter adapter;

    private String[] name = {"Цезарь", "Крабовый", "dsf"};

    private String[] price = {"400 руб", "300 руб", "sdsf"};

    private String[] weight = {"200 г", "100 г", "sfsdf"};
